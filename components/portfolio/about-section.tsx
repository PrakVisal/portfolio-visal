  ...
  return (
    <section id="about" className="bg-white px-4 py-16">
      <div className="container mx-auto">
        <h2 className="mb-12 text-center text-3xl font-bold text-gray-900">About me</h2>
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div>
            <div className="mb-6">
              <h3 className="mb-2 text-xl font-bold text-gray-900">UI/UX Designer</h3>
              <div className="mb-4 h-1 w-16 bg-yellow-400"></div>
            </div>
            <div className="mb-6">
              <h3 className="mb-2 text-xl font-bold text-gray-900">Backend Developer</h3>
              <div className="mb-4 h-1 w-16 bg-yellow-400"></div>
            </div>
