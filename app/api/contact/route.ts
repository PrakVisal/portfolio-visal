  ...
  try {
    ...
    try {
      ...
      return NextResponse.json(
        createSuccessResponse("Message sent successfully! I'll get back to you soon.", { submissionId }),
      )
    } finally {
      client.release()
    }
    ...
    if (error instanceof ZodError) {
      ...
      return NextResponse.json(createErrorResponse("Validation failed", fieldErrors), { status: 400 })
    }
